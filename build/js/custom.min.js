...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        if ($("#canvasDoughnut").length) {
            var datafbUser= $('#DataFacebookUsers').val();
            var dataNormalUser= $('#DataNormalUsers').val();
            var f = document.getElementById("canvasDoughnut"), i = {
                labels: ["Facebook Users %", "Normal Users %"],
                datasets: [{
                    data: [datafbUser, dataNormalUser],
                    backgroundColor: ["#3b5998", "#ff5a5f"],
                    hoverBackgroundColor: ["#5777ba", "#ff8a8e"]
                }]
            };
    ...
    if ("undefined" != typeof $.fn.fullCalendar) {
        ...
        var e, f, a = new Date, b = a.getDate(), c = a.getMonth(), d = a.getFullYear(),
            g = $("#calendar").fullCalendar({
                ...
                editable: !0,
                events: [{title: "Doble", start: new Date(d, c, 1)}, {
                    title: "Matrimonial",
                    start: new Date(d, c, b - 5),
                    end: new Date(d, c, b - 2)
                }, {title: "Suite", start: new Date(d, c, b, 10, 30), allDay: !1}, {
                    title: "Suite",
